...
const RulesSection = () => {
  ...
  return (
    <section id="rules" className="py-20 bg-bso-beige">
      <div className="container mx-auto">
        ...
        <div className="text-center">
          <Button 
            variant="outline" 
            size="lg"
            className="border-bso-blue text-bso-blue hover:bg-bso-blue hover:text-white"
            onClick={() => window.open("https://docs.google.com/document/d/1XYZ123/edit", "_blank")}
          >
